...
public class CircularIntFifoBuffer {
     ...
     */
    public CircularIntFifoBuffer(int size) {
        if (size <= 0) {
    ...
    public static void main(String[] args) {
        int bufferSize = 3;
        CircularIntFifoBuffer buffer = new CircularIntFifoBuffer(bufferSize);
